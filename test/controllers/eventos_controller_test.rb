...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { contratante: @evento.contratante, date: @evento.date, description: @evento.description, status: @evento.status, title: @evento.title } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { contratante: @evento.contratante, date: @evento.date, description: @evento.description, status: @evento.status, title: @evento.title } }
